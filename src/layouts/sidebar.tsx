...
const Sidebar = () => {
  ...
  return (
    <aside
      className={`flex-none bg-gray-200 transition-all duration-300 flex flex-row h-screen relative ${
        isMenuExtended ? "w-64" : "w-16"
      }`}
    >
      <div className="w-16 h-screen flex flex-col items-center justify-center">
        ...
        <div className="absolute bottom-0 left-0 w-full h-16 bg-gray-300 flex items-center justify-center">
